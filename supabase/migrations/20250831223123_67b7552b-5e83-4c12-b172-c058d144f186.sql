-- Security Fix 1: Add unique constraint to profiles.user_id to prevent duplicate profiles
ALTER TABLE public.profiles ADD CONSTRAINT profiles_user_id_unique UNIQUE (user_id);

-- Security Fix 2: Update SECURITY DEFINER functions to validate user ownership
